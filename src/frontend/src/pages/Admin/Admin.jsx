...
const Admin = () => {
  ...
  const productData=async () => {
    try {
      const response = await fetch(`http://3.89.202.193:8080/api/v1/instrumentos`)
...
const listarCategorias = async() => {
  ...
  const listaReservas = async() => {
    try{
      const response =   await fetch('http://3.89.202.193:8080/api/v1/reservas')
      const data = await response.json()
  ...
  const userData=async () => {
    try {
      const response = await fetch(`http://3.89.202.193:8080/api/v1/usuarios/listar`)
      const data = await response.json();
      console.log(data);
